...
#define NEARCLIP_ON	0x00010001
#define	NEARCLIP_OFF	0x00000001
/*
 * nc should be one of: NEARCLIP_ON or NEARCLIP_OFF
 */
#define	gSPNearClip(pkt, nc)	gMoveWd(pkt, G_MW_CLIP, G_MWO_CLIP_Z, nc)
#define	gsSPNearClip(nc)	gsMoveWd(    G_MW_CLIP, G_MWO_CLIP_Z, nc)
